...
module PlaceOS::Model
  class AiApprovalRequest < ModelBase
    ...
    attribute status : String = "pending", sanitize: :text
    attribute requested_by : String, sanitize: :text
    attribute request_note : String? = nil, sanitize: :common
    attribute decided_by : String? = nil, sanitize: :text
    ...
    attribute execution_mode : String = "approval_only", sanitize: :text
